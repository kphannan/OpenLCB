...
#define BOOT_VERSION    0xA5 // Ver A5 for OpenLCB
...
#define EB_DEFAULT      0xFF //DEG do auto-baud
#define BTC1_DEFAULT    0x0E //DEG 125K baud, compatible with OpenLCB
#define BTC2_DEFAULT    0x0C
#define BTC3_DEFAULT    0x37
