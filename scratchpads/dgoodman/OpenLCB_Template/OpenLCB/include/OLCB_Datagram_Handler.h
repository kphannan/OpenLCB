...
class OLCB_Datagram_Handler : public OLCB_Virtual_Node
{
 public:
  ...
  {
    _rxDatagramBuffer = new OLCB_Datagram; //(OLCB_Datagram*)malloc(sizeof(OLCB_Datagram));
    _txDatagramBuffer = new OLCB_Datagram; //(OLCB_Datagram*)malloc(sizeof(OLCB_Datagram));
  }
