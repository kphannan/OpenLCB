...
uses
  Classes, SysUtils, strutils, ExtCtrls, olcb_defines,
  {$IFDEF MSWINDOWS}
  Windows,
  {$ELSE}
  LclIntf,
...
type
  ...
  public
    ...
    procedure IntToByteArray(Int: QWord; var ByteArray: TByteArray);
  end;
...
procedure TOpenLCBMessageHelper.IntToByteArray(Int: QWord; var ByteArray: TByteArray);
begin
