...
const
  USER_MAX_VNODE_SUPPORTED_EVENTS_PRODUCED = 4;
{$ELSE}
const
...
const
  USER_MAX_VNODE_SUPPORTED_DYNAMIC_EVENTS_PRODUCED = 1;                         // IsProxiedDccAddress
...
// Define the UIDs of Events that are Produced by this Node
  ...
  const
    USER_VNODE_SUPPORTED_EVENTS_PRODUCED: array[0..USER_MAX_VNODE_SUPPORTED_EVENTS_PRODUCED-1] of TEventID = (
      ...
      ($01, $01, $00, $00, $00, $00, $03, $04),                                 // Is Idle Proxy
      ($01, $01, $00, $00, $00, $00, $03, $05)                                  // Is InUse Proxy
    );
  {$ENDIF}
