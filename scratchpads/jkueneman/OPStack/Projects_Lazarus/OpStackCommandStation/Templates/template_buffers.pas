...
const
  USER_MAX_SIMPLE_ARRAY_BUFFERS = 1000;
  ...
  USER_MAX_MESSAGE_ARRAY_BUFFERS = 200;    // Enter the size of the buffer to hold Messages, this should be at LEAST equal to the number of Nodes, 2x is recommended
